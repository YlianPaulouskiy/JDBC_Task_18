...
/**
 * Thread rectangular triangle
 */
public class RectangularCheckThread extends Thread {
    ...
    public RectangularCheckThread(String name) {
        super(name);
     ...
     * if There is to add this triangle in rectangular_triangles table
     */
    @Override
    public void run() {
        List<Triangle> triangleList = service.findAll();
        String table = "rectangular_triangles";
        for (Triangle triangle : triangleList) {
            if (logic.isRectangular(triangle)) {
